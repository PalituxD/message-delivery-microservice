...
public class PostalController {
    ...
    @PostMapping(value = Constants.URL_API_V1_PUT_EMAIL
    ...
    @GetMapping(value = Constants.URL_API_V1_SEARCH
            , consumes = MediaType.APPLICATION_JSON_VALUE
            , produces = MediaType.APPLICATION_JSON_VALUE)
    public MessageInfoDto get(@Valid MessageHeaderDto messageHeaderDto) throws ResourceNotFoundException {
